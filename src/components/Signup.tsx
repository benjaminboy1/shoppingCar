  ...
  return (
    <SafeAreaView className=" ">
      ...
      {/** title */}
        ...
        <Animated.Text entering={FadeInLeft.delay(200).duration(1000).springify()} style={{ fontFamily: 'YoungSerif-Regular' }} className="text-4xl font-bold tracking-wider">SignUp</Animated.Text>
        </View>
      ...
      {/** form */}
        <View className="flex items-center mx-4 space-y-4">
          ...
          <Animated.View entering={FadeInLeft.delay(200).duration(1000).springify()} className="bg-black/5 p-3 rounded-2xl w-full">
              <TextInput placeholder="Email Adress" placeholderTextColor={'gray'} />
           </Animated.View>
